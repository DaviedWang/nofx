...
func GetDefaultStrategyConfig(lang string) StrategyConfig {
	config := StrategyConfig{
		...
		RiskControl: RiskControlConfig{
			...
			BTCETHMaxPositionValueRatio:     1.5, // Max position = 150% equity (30% margin at 5x leverage)
			AltcoinMaxPositionValueRatio:    1.5, // Max position = 150% equity (30% margin at 5x leverage)
			MaxMarginUsage:                  0.3, // Total margin ≤ 30% equity (CODE ENFORCED)
